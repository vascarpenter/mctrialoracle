...
SET DEFINE OFF;
Insert into ADMIN.EVENTS (ID,"hospital_id","serialid","eventid","date","alive","dropout","macce","bh","bw","sbp","dbp","hr","event","diffdays") values (1,7,1,1,to_date('19-03-04','RR-MM-DD'),1,0,0,170,50,120,80,60,'test-711',null);
...
SET DEFINE OFF;
Insert into ADMIN.PATIENTS (ID,PATIENT_ID,"hospital_id","serialid","trialgroup","initial","birthdate","female","age","allowdate","startdate","dropdate","maccedate","deaddate","finishdate","diffdays") values (1,'1',7,1,0,'A.I.',to_date('70-03-04','RR-MM-DD'),0,49,to_date('19-03-03','RR-MM-DD'),to_date('19-03-03','RR-MM-DD'),to_date('19-05-22','RR-MM-DD'),null,null,null,null);
Insert into ADMIN.PATIENTS (ID,PATIENT_ID,"hospital_id","serialid","trialgroup","initial","birthdate","female","age","allowdate","startdate","dropdate","maccedate","deaddate","finishdate","diffdays") values (2,'2',7,2,0,'B.C',to_date('50-05-06','RR-MM-DD'),0,69,to_date('19-03-03','RR-MM-DD'),to_date('19-03-03','RR-MM-DD'),null,null,null,to_date('20-03-09','RR-MM-DD'),null);
Insert into ADMIN.PATIENTS (ID,PATIENT_ID,"hospital_id","serialid","trialgroup","initial","birthdate","female","age","allowdate","startdate","dropdate","maccedate","deaddate","finishdate","diffdays") values (3,'3',7,3,0,'D.E',to_date('60-01-23','RR-MM-DD'),0,50,to_date('19-03-03','RR-MM-DD'),to_date('19-03-03','RR-MM-DD'),null,null,null,to_date('20-03-09','RR-MM-DD'),null);
...
Insert into ADMIN.PATIENTS (ID,PATIENT_ID,"hospital_id","serialid","trialgroup","initial","birthdate","female","age","allowdate","startdate","dropdate","maccedate","deaddate","finishdate","diffdays") values (5,'7',7,4,0,'T.T',to_date('70-01-01','RR-MM-DD'),0,50,to_date('19-03-03','RR-MM-DD'),to_date('19-03-03','RR-MM-DD'),to_date('19-04-12','RR-MM-DD'),null,null,null,null);
Insert into ADMIN.PATIENTS (ID,PATIENT_ID,"hospital_id","serialid","trialgroup","initial","birthdate","female","age","allowdate","startdate","dropdate","maccedate","deaddate","finishdate","diffdays") values (6,'8',7,5,0,'F.G',to_date('20-01-01','RR-MM-DD'),0,100,to_date('19-03-03','RR-MM-DD'),to_date('19-03-03','RR-MM-DD'),to_date('19-04-02','RR-MM-DD'),null,null,null,null);
...
--------------------------------------------------------
  ...
  ALTER TABLE "ADMIN"."EVENTS" MODIFY ("hospital_id" NOT NULL ENABLE);
  ALTER TABLE "ADMIN"."EVENTS" MODIFY ("serialid" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "ADMIN"."PATIENTS" MODIFY ("hospital_id" NOT NULL ENABLE);
  ALTER TABLE "ADMIN"."PATIENTS" MODIFY ("serialid" NOT NULL ENABLE);
  ALTER TABLE "ADMIN"."PATIENTS" MODIFY ("trialgroup" NOT NULL ENABLE);
